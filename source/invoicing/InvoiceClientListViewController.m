//
//  InvoiceClientListViewController.m
//  invoicing
//
...
@implementation InvoiceClientListViewController
...
- (void)refreshClientList
{
    ...
    request.predicate = [NSPredicate predicateWithFormat:@"invoices.@count > 0"];  
    ...
    if (![self.fetchedResultsController performFetch:&error]) {
        ...
        NSLog(@"invoice clients: got %d entries", [[self.fetchedResultsController fetchedObjects] count]);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[self.fetchedResultsController fetchedObjects] count] == 0) {
        ...
        cell.detailTextLabel.text = @"There are no invoices defined"; 
        ...
        int q = [[client mutableSetValueForKey:@"invoices"] count];
        cell.detailTextLabel.text = [NSString stringWithFormat:@"%i invoices", q];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    InvoiceListViewController *dvController = [[InvoiceListViewController alloc] initWithNibName:@"InvoiceListView" bundle:[NSBundle mainBundle]];
